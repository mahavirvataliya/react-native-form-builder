...
- [react-native-form-builder](#react-native-form-builder)
- [Note:](#note)
  - [Features](#features)
  ...
  - [Properties](#properties)
    ...
    - [TextInput](#textinput)
      ...
      - [Value Type : `String` ( Except for type `number` )](#value-type--string--except-for-type-number)
    - [Picker](#picker)
      - [Extra Properties](#extra-properties-1)
      - [Value Type : `String`](#value-type--string)
      - [Default Value Type :](#default-value-type)
    - [Switch](#switch)
      - [Value Type : `Boolean`](#value-type--boolean)
    - [Date](#date)
      - [Extra Properties](#extra-properties-2)
      - [Value Type : `String`](#value-type--string-1)
      - [Default Value Type : `string` or `JS Date object`](#default-value-type--string-or-js-date-object)
    - [Select](#select)
      - [Extra Properties](#extra-properties-3)
      - [Value Type : Array of `Strings` or `Objects`](#value-type--array-of-strings-or-objects)
      - [Array of Strings](#array-of-strings)
      - [Array of Objects](#array-of-objects)
      - [Default Value Type : `string` or `JS Date object`](#default-value-type--string-or-js-date-object-1)
  - [Nested Forms](#nested-forms)
      - [Value Type : `Object`](#value-type--object)
      - [Default Value Type : `Object`](#default-value-type--object)
  - [Prefill Form Values](#prefill-form-values)
  ...
  - [Add Custom Error Component](#add-custom-error-component)
  - [Example](#example)
